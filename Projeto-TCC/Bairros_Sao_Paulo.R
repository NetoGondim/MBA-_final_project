...
dados_bairros <- read.csv('C:/Users/Neto/Documents/MBA_project/Projeto-TCC/arquivos/Dataset_utf_8_IDHM_2000_2010.csv', encoding = "UTF-8")
...
mapa_desigualdade <- read.csv("C:/Users/Neto/Documents/MBA_project/Projeto-TCC/Mapa-da-Desigualdade-2022-–-planilha-aberta.csv", encoding = "UTF-8")
